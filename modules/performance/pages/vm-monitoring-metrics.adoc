...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/virtualization/monitoring#virt-monitoring_virt-monitoring[OpenShift Virtualization Monitoring Documentation,window=_blank]
