...
xref:attachment$vms/fedora-basic.yaml[Download fedora-basic.yaml]
...
xref:attachment$vms/fedora-multi-network.yaml[Download fedora-multi-network.yaml]
...
xref:attachment$vms/rhel9-vm.yaml[Download rhel9-vm.yaml]
...
xref:attachment$vms/rhel9-with-data-disk.yaml[Download rhel9-with-data-disk.yaml]
...
xref:attachment$vms/windows-2022.yaml[Download windows-2022.yaml]
