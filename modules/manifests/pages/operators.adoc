...
xref:attachment$operators/lvm-namespace.yaml[Download lvm-namespace.yaml]
...
xref:attachment$operators/lvm-operatorgroup.yaml[Download lvm-operatorgroup.yaml]
...
xref:attachment$operators/lvm-subscription.yaml[Download lvm-subscription.yaml]
...
xref:attachment$operators/ovs-bridge-mapping-nncp.yaml[Download ovs-bridge-mapping-nncp.yaml]
