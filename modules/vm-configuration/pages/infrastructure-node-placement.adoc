...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/virtualization/postinstallation-configuration#virt-about-node-placement-virt-components_virt-specifying-nodes-for-virtualization-components[About node placement for virtualization components - Red Hat Documentation,window=_blank]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html/virtualization/getting_started#about-hco_virt-using-the-cli-tools[About the HyperConverged custom resource - Red Hat Documentation,window=_blank]
