...
xref:attachment$source-webserver-vm.yaml[Download source-webserver-vm.yaml]
...
xref:attachment$clone-datavolume.yaml[Download clone-datavolume.yaml]
...
xref:attachment$vm-from-cloned-pvc.yaml[Download vm-from-cloned-pvc.yaml]
...
xref:attachment$cloned-vm-with-cloudinit.yaml[Download cloned-vm-with-cloudinit.yaml]
...
xref:attachment$cross-namespace-clone-rbac.yaml[Download cross-namespace-clone-rbac.yaml]
...
xref:attachment$cross-namespace-clone-datavolume.yaml[Download cross-namespace-clone-datavolume.yaml]
...
xref:attachment$cloned-webserver-production.yaml[Download cloned-webserver-production.yaml]
