...
xref:attachment$golden-image-base-vm.yaml[Download golden-image-base-vm.yaml]
...
xref:attachment$golden-image-datasource.yaml[Download golden-image-datasource.yaml]
...
xref:attachment$webserver-vm-from-golden.yaml[Download webserver-vm-from-golden.yaml]
...
xref:attachment$webserver-vm-2.yaml[Download webserver-vm-2.yaml]
