...
xref:attachment$fedora-dhcp-vm.yaml[Download fedora-dhcp-vm.yaml]
...
xref:attachment$fedora-static-ip-vm.yaml[Download fedora-static-ip-vm.yaml]
...
xref:attachment$fedora-multi-network-vm.yaml[Download fedora-multi-network-vm.yaml]
...
xref:attachment$fedora-vlan-static-ip-vm.yaml[Download fedora-vlan-static-ip-vm.yaml]
