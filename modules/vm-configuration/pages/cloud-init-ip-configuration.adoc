...
xref:attachment$cloud-init-ip-configuration/fedora-dhcp-vm.yaml[Download fedora-dhcp-vm.yaml]
...
xref:attachment$cloud-init-ip-configuration/fedora-static-ip-vm.yaml[Download fedora-static-ip-vm.yaml]
...
xref:attachment$cloud-init-ip-configuration/fedora-multi-network-vm.yaml[Download fedora-multi-network-vm.yaml]
...
xref:attachment$cloud-init-ip-configuration/fedora-vlan-static-ip-vm.yaml[Download fedora-vlan-static-ip-vm.yaml]
