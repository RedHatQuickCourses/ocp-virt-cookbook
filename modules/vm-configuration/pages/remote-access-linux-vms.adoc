...
xref:attachment$fedora-access-vm.yaml[Download fedora-access-vm.yaml]
...
xref:attachment$ssh-nodeport-service.yaml[Download ssh-nodeport-service.yaml]
...
xref:attachment$fedora-vlan-access-vm.yaml[Download fedora-vlan-access-vm.yaml]
