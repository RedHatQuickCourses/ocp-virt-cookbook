...
NOTE: This cookbook DOES NOT replace the official link:https://www.redhat.com/en/services/training/do316-managing-virtual-machines-red-hat-openshift-virtualization[OpenShift Virtualization training kit,window=_blank], which is highly recommended, nor the link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html-single/virtualization/index[official documentation,window=_blank]. Instead, it is supposed to serve as a complement and a facilitator to partner and customer engineers just getting started.
