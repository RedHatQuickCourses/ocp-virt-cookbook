...
WARNING: This cookbook DOES NOT replace the official OpenShift Virtualization training, which is highly recommended, nor the official documentation. Instead, it is supposed to serve as a complement and a facilitator to partner and customer engineers just getting started.
...
* **xref:vm-configuration:index.adoc[Virtual Machine Configuration]** - VM setup and cloud-init
...
This cookbook is actively maintained. For questions, issues, or contributions, please refer to the project repository.
