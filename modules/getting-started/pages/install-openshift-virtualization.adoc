...
* **OpenShift 4.20+** installed and running
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/virtualization/installing[OpenShift Virtualization Installation Documentation,window=_blank]
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.20/html/virtualization/getting-started[OpenShift Virtualization Getting Started,window=_blank]
