...
* xref:vm-configuration:static-ip-configuration.adoc[Configure static IPs for VMs] - Static IP configuration using cloud-init, DHCP reservations, guest agent, and Sysprep
