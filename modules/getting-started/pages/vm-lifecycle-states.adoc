...
image::vm-vmi-relationship.png[Relationship between VirtualMachine and VirtualMachineInstance]
...
image::vm-lifecycle-states.png[VM lifecycle state transitions]
...
+
NOTE: TODO: Add screenshot for this section - VirtualMachines list and Start action in web console.
...
. Click **Actions** -> **Stop**
+
NOTE: TODO: Add screenshot for this section - VM details page with Stop action in web console.
...
+
NOTE: TODO: Add screenshot for this section - VM details page with Pause/Unpause actions in web console.
...
+
NOTE: TODO: Add screenshot for this section - VM details page with Restart action in web console.
...
. Click **Delete**
+
NOTE: TODO: Add screenshot for this section - VM Delete action and confirmation dialog in web console.
...
. Click **Save**
+
NOTE: TODO: Add screenshot for this section - VM YAML tab with runStrategy in web console.
