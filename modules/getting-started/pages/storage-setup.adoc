...
You have successfully configured a default storage class for OpenShift Virtualization. This simplifies VM deployment by automatically assigning storage when no specific storage class is requested.

== See Also

* xref:storage:lvm-operator.adoc[LVM Storage Operator Installation]
