...
* OpenShift 4.18+ with OpenShift Virtualization operator installed (tested on 4.20)
...
Use your preferred text editor to customize the manifest:
...
== Step 2: Create a VM with DataVolume Boot Source
...
vm-datavolume   ImportInProgress   0.00%          10s
vm-datavolume   ImportInProgress   45.2%          30s
...
== Step 3: Customize CPU, Memory, and Advanced Cloud-init
...
== Step 4: VM Lifecycle Operations
...
Check the VirtualMachine and VirtualMachineInstance events:
