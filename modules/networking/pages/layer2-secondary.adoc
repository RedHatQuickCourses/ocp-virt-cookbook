...
image::layer2-secondary-topology.png[Layer 2 Secondary Network Topology, align=center]
...
NOTE: Because Layer 2 secondary networks operate entirely within the OVN overlay, no `NodeNetworkConfigurationPolicy` (NNCP), bridge setup, or VLAN configuration is required on the cluster nodes. This makes Layer 2 the simplest secondary network option to deploy.
