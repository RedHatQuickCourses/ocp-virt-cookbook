...
xref:attachment$localnet-secondary-namespace.yaml[Download localnet-secondary-namespace.yaml]
...
xref:attachment$localnet-bridge-mapping-nncp.yaml[Download localnet-bridge-mapping-nncp.yaml]
...
xref:attachment$cudn-localnet.yaml[Download cudn-localnet.yaml]
...
xref:attachment$fedora-localnet-vm.yaml[Download fedora-localnet-vm.yaml]
