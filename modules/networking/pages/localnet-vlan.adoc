...
xref:attachment$localnet-vlan-namespace.yaml[Download localnet-vlan-namespace.yaml]
...
xref:attachment$localnet-vlan-bridge-mapping-nncp.yaml[Download localnet-vlan-bridge-mapping-nncp.yaml]
...
xref:attachment$localnet-vlan-100-nad.yaml[Download localnet-vlan-100-nad.yaml]
...
xref:attachment$fedora-vlan-vm.yaml[Download fedora-vlan-vm.yaml]
