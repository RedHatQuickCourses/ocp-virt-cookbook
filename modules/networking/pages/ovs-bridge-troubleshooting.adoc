...
# Check NetworkAttachmentDefinition or ClusterUserDefinedNetwork (CUDN) references the same name
...
* [ ] Logical network name matches what you'll use in NetworkAttachmentDefinition (NAD) / CUDN
