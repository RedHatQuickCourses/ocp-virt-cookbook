...
xref:attachment$udn-primary-namespace.yaml[Download udn-primary-namespace.yaml]
...
xref:attachment$udn-primary.yaml[Download udn-primary.yaml]
...
xref:attachment$fedora-vm-with-udn.yaml[Download fedora-vm-with-udn.yaml]
...
xref:attachment$fedora-vm-web-service.yaml[Download fedora-vm-web-service.yaml]
